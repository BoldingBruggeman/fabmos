...
setup(
    ...
    package_dir={"": "src"},
    ext_modules=[
        CMakeExtension("fabmos.fabm_tmm", "-DPYFABM_DEFINITIONS=_FABM_DIMENSION_COUNT_=2;_FABM_DEPTH_DIMENSION_INDEX_=2;_FABM_MASK_TYPE_=integer;_FABM_MASKED_VALUE_=0;_FABM_BOTTOM_INDEX_=-1"),
        CMakeExtension("fabmos.fabm_hz_only", "-DPYFABM_DEFINITIONS=_FABM_DIMENSION_COUNT_=1"),
    ],
